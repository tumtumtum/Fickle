...
{
	public class ObjectiveClassHeaderExpressionBinder
		: ServiceExpressionVisitor
	{
		public static Expression Bind(Expression expression)
		{
			var binder = new ObjectiveClassHeaderExpressionBinder();
		...
		protected override Expression VisitTypeDefinitionExpression(TypeDefinitionExpression expression)
		{
			...
			var referencedTypeExpressions = referencedTypes.Where(c => c is DryiceType && ((DryiceType)c).ServiceClass != null).Select(c => (Expression)new ReferencedTypeExpression(c)).ToList();
