...
namespace Dryice.Generators.Objective
{
		...
		: ServiceExpressionVisitor
	{
		...
		{
			var dictionaryType = new DryiceType("NSMutableDictionary");
		...
		private MethodDefinitionExpression CreateInitMethod(TypeDefinitionExpression expression)
		{
			...
			{	
				new ParameterDefinitionExpression("properties", new DryiceType("NSMutableDictionary"), 0)
			};
		...
		private Expression CreateCopyWithZoneMethod(TypeDefinitionExpression expression)
		{
			...
			var objectiveClassType = new DryiceType("Class");
			var currentType = new DryiceType(expression.Type.Name);
